...
**NOTE!** Before building the service, make sure to change the value of the `domain_prefix` variable under the `terraform/tfvars/common.tfvars` file. Otherwise you will encouter some errors because the domain name is already used.  
